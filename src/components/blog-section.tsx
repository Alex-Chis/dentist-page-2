  ...
  const articles = [
    {
      ...
      image: "https://images.unsplash.com/photo-1541599540903-216a46ca1dc0?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Our articles on dental health</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Stay informed with the latest tips, trends, and insights on maintaining optimal oral health.
          </p>
        </div>
          ...
          {articles.map((article, index) => (
            <div key={index} className="border rounded-xl overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                <Button variant="link" className="text-dentist-purple p-0 h-auto">
                  Read more →
                </Button>
              </div>
            </div>
