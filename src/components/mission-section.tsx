        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              With years of experience and a passionate commitment to patient
              care, our team of dental professionals is dedicated to providing
              the highest quality dental services in a comfortable, welcoming
              environment.
            </p>
